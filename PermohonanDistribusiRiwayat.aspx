<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="PermohonanDistribusiRiwayat.aspx.vb" Inherits="PermohonanDistribusiRiwayat" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function ConfirmCetak() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Apakah kertas yang disiapkan adalah kertas bekas?")) {
                confirm_value.value = "Yes";
            } else {
                confirm_value.value = "No";
            }
                                                        ...
                                                        <dx:ASPxGridView ID="gridMohonTT" runat="server"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <dx:GridViewDataTextColumn VisibleIndex="5" Caption="PILIHAN">
                                                                    <DataItemTemplate>
                                                                        <asp:Button ID="btnCetakNota" runat="server" OnClick="btnCetakNota_Click" Text="Cetak Tanda Terima"  OnClientClick="ConfirmCetak()"/>
