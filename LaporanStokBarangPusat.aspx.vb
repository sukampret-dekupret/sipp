...
Imports System.IO
Imports System.Data
Partial Class LaporanStokBarangPusat
    Inherits System.Web.UI.Page

    Private Sub LaporanStokBarangPusat_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Session("TGLAWAL") = xDate.AddDays(-2).ToShortDateString
    ...
    Protected Sub btnBUKUPERSEDIAAN_Click(sender As Object, e As EventArgs)
        ...
        Using (myConnection)
            ...
            myCommand.CommandText = "sp_LaporanTrx_Pusat"
