<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="LaporanStokBarangPusat.aspx.vb" Inherits="LaporanStokBarangPusat" %>
            ...
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="panel-tag">
                            <p>
                                Klik pada kode barang untuk melihat mutasi barang
                            </p>
                        </div>
                        <dx:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="BELUMDIPENUHI" ReadOnly="True" VisibleIndex="7" Width="10%">
                                </dx:GridViewDataTextColumn>
                            </Columns>
...
dbo.getJMLSERTERSPKperKDBRGperUNKER(KODE_BARANG,@KDUNKER,@DATEAWAL) as MASUK,
dbo.getJMLSERTERORDERperKDBRGperUNKER(KODE_BARANG,@KDUNKER,@DATEAWAL,1,0) as KELUAR,
...
dbo.getJMLSERTERSPKperKDBRGperUNKERperTGLantara(KODE_BARANG,@KDUNKER,@DATEAKHIR1,@DATEAKHIR2) as MASUK,
dbo.getJMLSERTERORDERperKDBRGperUNKERperTGLantara(KODE_BARANG,@KDUNKER,@DATEAKHIR1,@DATEAKHIR2,1,0) as KELUAR,
(dbo.getJMLSERTERSPKperKDBRGperUNKER(KODE_BARANG,@KDUNKER,@DATEAKHIR2) - dbo.getJMLSERTERORDERperKDBRGperUNKER(KODE_BARANG,@KDUNKER,@DATEAKHIR2,1,0)) as SALDO,
(dbo.getJMLSERTERSPKperKDBRGperUNKER(KODE_BARANG,@KDUNKER,@DATEAWAL) - dbo.getJMLSERTERORDERperKDBRGperUNKER(KODE_BARANG,@KDUNKER,@DATEAWAL,1,0)) as SALDOAWAL,
(dbo.getJMLPENUHIORDERperKDBRGperUNKER(KODE_BARANG,@KDUNKER,@DATEAKHIR2,1)- dbo.getJMLSERTERORDERperKDBRGperUNKER(KODE_BARANG,@KDUNKER,@DATEAKHIR2,1,0)) as BELUMDIPENUHI
FROM [TBL_BARANG] WHERE ST_BARANG=1 ORDER BY (dbo.getJMLSERTERSPKperKDBRGperUNKER(KODE_BARANG,@KDUNKER,@DATEAKHIR2) - dbo.getJMLSERTERORDERperKDBRGperUNKER(KODE_BARANG,@KDUNKER,@DATEAKHIR2,1,0)) DESC">
        <SelectParameters>
