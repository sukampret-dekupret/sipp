<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="OrderPending.aspx.vb" Inherits="OrderPending" %>
...
ON A.DRUNKER=B.KD_UNKER WHERE YEAR(TGL_NOTA)=@TAHUN AND A.DRUNKER=@KDUNKER AND dbo.GetStatusORDER(KDORDER)=0"
