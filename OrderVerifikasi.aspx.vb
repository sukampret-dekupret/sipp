...
Partial Class OrderVerifikasi
    ...
    Private Sub OrderVerifikasi_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    '    'If (e.GetValue("MOHON")) > (e.GetValue("STOK1")) Then
    '    '    e.Row.ForeColor = System.Drawing.Color.Red
    '    'ElseIf (e.GetValue("MOHON")) < (e.GetValue("STOK1")) Then
    ...
    Protected Sub gridDetail_RowValidating(sender As Object, e As Data.ASPxDataValidationEventArgs)
        Dim xMinta As Int16 = e.OldValues("MOHON")
        Dim xPenuhi As Int16 = e.NewValues("PENUHI")
        Dim xStok As Int16 = e.OldValues("STOK1")
    ...
    Private Sub grid_RowUpdated(sender As Object, e As ASPxDataUpdatedEventArgs) Handles grid.RowUpdated
        grid.Focus()
    End Sub
    Protected Sub btnUnduhNota_Click(sender As Object, e As EventArgs)
