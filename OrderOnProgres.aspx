<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="OrderOnProgres.aspx.vb" Inherits="OrderOnProgres" %>
...
ON A.DRUNKER=B.KD_UNKER WHERE YEAR(TGL_NOTA)=@TAHUN AND A.DRUNKER=@KDUNKER AND dbo.GetStatusORDER(KDORDER)=1"
