<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="OrderVerifikasiSelesai.aspx.vb" Inherits="OrderVerifikasiSelesai" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>Daftar  <span class="fw-300"><i>Permohonan Satker <b>Selesai</b></i></span>
                    </h2>
...
ON A.DRUNKER=B.KD_UNKER WHERE YEAR(TGL_NOTA)=@TAHUN AND A.KEUNKER=@KEUNKER AND dbo.GetStatusORDER(KDORDER)=5">
        <SelectParameters>
